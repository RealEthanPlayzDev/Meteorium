...
export declare function handlerFactory(processor?: ({ client, argv, }: {
    client: HolodexApiClient;
    argv: any;
}) => any, printer?: any): (argv: any) => Promise<void>;
export declare function resolveOrg(scope: string): string;
export declare function getClient(apiKey?: string): HolodexApiClient;
