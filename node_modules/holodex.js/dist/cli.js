...
class HolodexApiClient {
  constructor(options) {
    ...
    strict.ok(typeof options.apiKey === 'string', 'apiKey not provided.');
  ...
  async getChannels(params = {}) {
    ...
    const q = querystring.stringify(_extends({}, params, {
...
const handler$2 = handlerFactory(async ({
  ...
  console.log(chalk.gray((_channel$description = channel.description) == null ? void 0 : _channel$description.slice(0, 120), '...'));
});
const command$2 = {
  command: 'channel <id>',
...
const handler = handlerFactory(async ({
  ...
  console.log(videoLink(video.videoId, video.title));
  console.log(chalk.gray((_video$description = video.description) == null ? void 0 : _video$description.slice(0, 120), '...'));
});
const command = {
  command: 'video <id>',
